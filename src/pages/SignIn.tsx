...
import { toast } from "sonner"; // Assuming you are using Sonner from your App.tsx
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-md p-8 space-y-6 bg-white rounded-lg shadow-md">
        <h2 className="text-2xl font-bold text-center text-gray-900">Sign in to CoreInventory</h2>
        ...
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2 space-x-2 border border-gray-300 rounded-md hover:bg-gray-50 focus:outline-none"
        >
